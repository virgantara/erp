...
class m190118_200003_create_master_akun_perusahaan extends Migration
{
    public function safeUp()
    {
        $this->createTable('master_akun_perusahaan', [
            'kode_akun' => $this->string(8)->notNull(),
            'uraian_akun' => $this->string(50)->notNull()->unique(),
        ]);

        $this->alterColumn('{{%master_akun_perusahaan}}', 'kode_akun', $this->string(8).' PRIMARY KEY');

        $this->batchInsert('master_akun_perusahaan', 
